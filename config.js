...
const MENU_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR1vy2MbfyQntD7Ie0Ii0mx9t-S0MzMVM0atxOFNo2i53jHQWiuuayrJGMFwTY2gq-l0GlVTeknL7C7/pub?gid=1132427241&single=true&output=csv';

// URL of the spreadsheet with menu categories (tab: Categories)
const CATEGORIES_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR1vy2MbfyQntD7Ie0Ii0mx9t-S0MzMVM0atxOFNo2i53jHQWiuuayrJGMFwTY2gq-l0GlVTeknL7C7/pub?gid=271394769&single=true&output=csv';

// URL of the spreadsheet with general settings (tab: Config)
const CONFIG_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR1vy2MbfyQntD7Ie0Ii0mx9t-S0MzMVM0atxOFNo2i53jHQWiuuayrJGMFwTY2gq-l0GlVTeknL7C7/pub?gid=0&single=true&output=csv';

// URL of the spreadsheet with operating hours (tab: Hours)
const HOURS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR1vy2MbfyQntD7Ie0Ii0mx9t-S0MzMVM0atxOFNo2i53jHQWiuuayrJGMFwTY2gq-l0GlVTeknL7C7/pub?gid=1842804489&single=true&output=csv';

// URL of the spreadsheet with neighborhoods and delivery fees (tab: Bairros) **OPCIONAL**
const NEIGHBORHOODS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR1vy2MbfyQntD7Ie0Ii0mx9t-S0MzMVM0atxOFNo2i53jHQWiuuayrJGMFwTY2gq-l0GlVTeknL7C7/pub?gid=1634629476&single=true&output=csv';

// URL da planilha de cupons de desconto  **OPCIONAL**
const COUPONS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR1vy2MbfyQntD7Ie0Ii0mx9t-S0MzMVM0atxOFNo2i53jHQWiuuayrJGMFwTY2gq-l0GlVTeknL7C7/pub?gid=1144201431&single=true&output=csv';
 ...
 */
const PRELOADER_LOGO_URL = ''; // Adicione a URL do seu logo aqui
